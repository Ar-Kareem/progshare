...
# tail -n ${1-100} -f ./logs/nginx/access.log ./logs/nginx/error.log ./logs/nginx/cart-err.log ./logs/redis/redis-server.log ./logs/traefik_logs/traefik_access.json  ./logs/traefik_logs/traefik_logs.json
